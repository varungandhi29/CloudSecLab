    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-card border border-gray-800 rounded-2xl p-8 shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-extrabold text-white">Create CloudSecLab Account</h2>
          <p className="text-xs text-gray-400 font-mono">Start mastering AWS, Azure & GCP security</p>
        </div>
        ...
        <div className="relative flex py-2 items-center">
          ...
          <span className="flex-shrink mx-4 text-xs font-mono text-gray-500 uppercase">Or register with email</span>
          <div className="flex-grow border-t border-gray-800"></div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-950 border border-gray-800 rounded-xl px-4 py-2.5 text-sm text-gray-200 focus:outline-none focus:border-cyan-500 font-mono"
              placeholder="Jane Doe"
            />
          </div>

          <div>
            <label className="text-xs font-mono text-gray-300 block mb-1.5">USERNAME</label>
            <input
              type="text"
              required
              value={username}
